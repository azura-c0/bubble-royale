...
export const PLAYER_ACCELERATION = 0.0035;
export const PLAYER_RADIUS = 14;
export const PLAYER_MAX_VELOCITY = 0.4;
...
export const BOOST_MAX_VELOCITY = 0.6;
export const BOOST_MAX = 350;
export const BOOST_INCREASE = 75;
...
// BUBBLE SETTINGS
export const MAX_BUBBLE_RADIUS = 1000;
export const BUBBLE_SHRINK_RATE = 0.9998;
export const BUBBLE_SPEED = 1.35;
